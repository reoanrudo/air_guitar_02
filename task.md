...
| エージェント | 役割 | 担当領域 | タスク |
|------------|------|---------|------|
| **Sub-Agent-1** | バックエンド基盤 | プロジェクトセットアップ、データモデル、認証 | 1.1, 1.2, 1.3 |
| **Sub-Agent-2** | フロントエンド基盤 | テンプレート、UI/UX、静的リソース | 1.4, 1.5, 1.6 |
| **Sub-Agent-3** | WebSocket/リアルタイム | チャネル設定、QRコード、スマホ連携 | 1.10, 1.11, 1.13 |
| **Sub-Agent-4** | カメラ/メディア | MediaPipe統合、ジェスチャー認識、視覚フィードバック | 1.12, 1.16 |
| **Sub-Agent-5** | ビジネスロジック | 練習記録、進捗管理、ゲームデータモデル | 1.7, 1.8, 1.9, 1.15 |
