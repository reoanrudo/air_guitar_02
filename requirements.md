...
**優先度:** 高
**ユーザーストーリー:** リアルなギター体験をするため、スマホ（左手操作）とPC（右手操作）を連携させて演奏したい。なぜなら、実際のギターに近い操作感を得たいから
...
**優先度:** 高
**ユーザーストーリー:** PCのWebカメラを使って右手のストローク動作を検知したい。なぜなら、実際のギターのストローク感を再現したいから
...
**優先度:** 高
**ユーザーコトーリー:** ゲーム感覚で楽しくリズム練習をしたい。なぜなら、遊びながら練習することで継続意欲を高めたいから
...
**優先度:** 中
**ユーザーストーリー:** 音が「迫ってくる」ような体験を通して、リズムの感覚を掴みたい。なぜなら、視覚的な刺激で演奏のリズムをつかみたいから
...
**優先度:** 中
**ユーザーコトーリー:** 他のユーザーと競い合うことで、モチベーションを維持したい。なぜなら、社会的な要素が追加されると続けたくなるから
